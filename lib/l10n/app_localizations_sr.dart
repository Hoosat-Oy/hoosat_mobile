...
class AppLocalizationsSr extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Додавање Hoosat чвора није успело';
  ...
  String get insufficientBalanceDetails =>
      'Немате довољно HTN за ову трансакцију';
  ...
  @override
  String get hoosatDevFund => 'Каспа Дев Фонд';

  @override
  String get hoosatMobile => 'Каспиум Новчаник';
  ...
  @override
  String get shareHoosatMobile => 'Подели Каспиум';

  @override
  String get shareHoosatMobileSubject => 'Погледај Каспиум Новчаник';

  @override
  String get shareHoosatMobileText =>
      'Погледај Каспиум - Каспа Мобилни Новчаник.\nВебсајт - mobile.hoosat.fi';
  ...
  String get compoundRequiredDescription =>
      'Imate mnogo malih neiskorišćenih izlaza (UTXO). Konsolidacija će ih spojiti u manji broj većih UTXO-a, pa će buduća slanja biti brža i možda sa nižim naknadama. Ovo kreira jednu ili više transakcija i podrazumeva mrežne naknade.';
