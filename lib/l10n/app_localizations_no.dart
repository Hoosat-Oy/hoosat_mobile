...
class AppLocalizationsNo extends AppLocalizations {
  ...
  String get insufficientBalanceDetails =>
      'Du har ikke nok HTN for denne transaksjonen';
  ...
  @override
  String get hoosatDevFund => 'Hoosat utviklerfond';
  ...
  @override
  String get nodeDeleteTitle => 'Slett Hoosat nodekonfigurasjon?';
  ...
  @override
  String get shareHoosatMobileSubject => 'Sjekk ut Hoosat Mobile Wallet';

  @override
  String get shareHoosatMobileText =>
      'Sjekk ut Hoosat Mobile - Den mobile lommeboken for Hoosat.\nNettsted - mobile.hoosat.fi';
  ...
  String transferComplete(String amount) {
    return '$amount HTN ble overført til din Hoosat Mobile lommebok.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'En lommebok med balanse $amount HTN ble oppdaget.';
  }
  ...
  String transferIntro(String button) {
    return 'Denne prosessen vil overføre midler fra en papirlommebok til din Hoosat Mobile lommebok.\n\nTrykk på \"$button\"-knappen for å starte.';
  }
  ...
  @override
  String get transferNoFunds => 'Det er ingen HTN på denne seeden';
  ...
  @override
  String get transferQrScanHint => 'Skan HTN \nSeed eller privat nøkkel';
  ...
  String welcomeMessage(String version) {
    return 'Velkommen!\n\nDette er versjon $version av Hoosat Mobile - Den mobile lommeboken for Hoosat';
  }

  @override
  String get welcomeText =>
      'Velkommen til Hoosat Mobile. Opprett en ny lommebok eller importer en eksisterende for å begynne.';
  ...
  String get compoundRequiredDescription =>
      'Du har mange små ubrukte utganger (UTXO). Konsolidering vil slå dem sammen til færre, større UTXO-er slik at fremtidige sendinger går raskere og kanskje med lavere gebyrer. Dette oppretter én eller flere transaksjoner og påløper nettverksgebyrer.';
