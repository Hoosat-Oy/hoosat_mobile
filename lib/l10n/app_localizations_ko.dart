...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Hoosat 노드 추가 실패';
  ...
  String get exampleCardIntro =>
      'Hoosat에 오신 것을 환영합니다. HTN를 받으시면 거래가 다음과 같이 표시됩니다.';
  ...
  @override
  String get insufficientBalanceDetails => '이 거래에는 충분한 HTN가 없습니다';
  ...
  @override
  String get hoosatDevFund => 'Hoosat 개발자 기금';

  @override
  String get hoosatMobile => 'Hoosat Mobile 지갑';
  ...
  @override
  String get nodeAddress => 'Hoosat 노드';

  @override
  String get nodeDeleteMessage => '삭제하시겠습니까?';

  @override
  String get nodeDeleteTitle => 'Hoosat 노드 설정을 삭제하시겠습니까?';
  ...
  @override
  String get nodesSheetTitle => 'Hoosat 노드';
  ...
  @override
  String get shareHoosatMobile => 'Hoosat Mobile 공유 ';

  @override
  String get shareHoosatMobileSubject => 'Check out Hoosat Mobile Wallet';

  @override
  String get shareHoosatMobileText => 'Hoosat을 확인하세요! Hoosat의 공식 Android 지갑!';
  ...
  String transferComplete(String amount) {
    return '$amount HTN successfully transferred to your Hoosat Mobile Wallet.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'A wallet with a balance of $amount HTN has been detected.';
  }
  ...
  String transferIntro(String button) {
    return 'This process will transfer the funds from a paper wallet to your Hoosat Mobile wallet.\n\nTap the \"$button\" button to start.';
  }
  ...
  @override
  String get transferNoFunds => 'This seed does not have any HTN on it';
  ...
  @override
  String get transferQrScanHint => 'Scan a Hoosat \nseed or private key';
  ...
  String get welcomeText =>
      'Hoosat에 오신 것을 환영합니다. 계속하려면, 새 지갑을 만들거나 기존 지갑을 불러오세요.';
  ...
  String get compoundRequiredDescription =>
      '많은 소액의 미사용 출력(UTXO)이 있습니다. 통합하면 이를 더 적고 더 큰 UTXO로 합쳐, 향후 전송이 더 빨라지고 수수료가 더 낮아질 수 있습니다. 이 작업은 하나 이상의 트랜잭션을 생성하며 네트워크 수수료가 발생합니다.';
