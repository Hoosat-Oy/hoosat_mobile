...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Αποτυχία προσθήκης κόμβου Hoosat';
  ...
  String get insufficientBalanceDetails =>
      'Δεν έχετε αρκετά HTN για αυτήν την συναλλαγή';
  ...
  @override
  String get hoosatDevFund => 'Κονδύλιο προγραμματιστών Hoosat';

  @override
  String get hoosatMobile => 'Το πορτοφόλι Hoosat Mobile';
  ...
  @override
  String get nodeAddress => 'Κόμβος Hoosat';

  @override
  String get nodeDeleteMessage => 'Είστε σίγουροι ότι θέλετε να το διαγράψετε;';

  @override
  String get nodeDeleteTitle => 'Να διαγραφούν οι ρυθμίσεις του κόμβου Hoosat;';
  ...
  @override
  String get nodesSheetTitle => 'Κόμβοι Hoosat';
  ...
  @override
  String get shareHoosatMobile => 'Μοιράστε το Hoosat Mobile';

  @override
  String get shareHoosatMobileSubject =>
      'Τσεκάρετε το πορτοφόλι Hoosat Mobile!';

  @override
  String get shareHoosatMobileText =>
      'Τσεκάρετε το Hoosat Mobile! Το φορητό πορτοφόλι για το Hoosat. Ιστοσελίδα - mobile.hoosat.fi';
  ...
  String transferComplete(String amount) {
    return '$amount HTN μεταφέρθηκαν επιτυχώς στο Hoosat Mobile πορτοφόλι σας.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Εντοπίσθηκε ένα πορτοφόλι με υπόλοιπο $amount HTN.';
  }
  ...
  String transferIntro(String button) {
    return 'Η διαδικασία αυτή θα μεταφέρει τα κεφάλαιο από το χάρτινο πορτοφόλι στο πορτοφόλι Hoosat Mobile.\n\nΠατήστε το  \"$button\" κουμπί για να ξεκινήσετε.';
  }
  ...
  String get transferNoFunds =>
      'Το πορτοφόλι που αντιστοιχεί σε αυτήν την μυστική φράση, δεν διαθέτει υπόλοιπο HTN.';
  ...
  String get transferQrScanHint =>
      'Σαρώστε μία μυστική φράση Hoosat ή ένα ιδιωτικό κλειδί.';
  ...
  String welcomeMessage(String version) {
    return 'Καλως ήρθατε!\n\nΑυτή είναι η έκδοση $version του Hoosat Mobile - το φορητό πορτοφόλι για το Hoosat\n ';
  }

  @override
  String get welcomeText =>
      'Καλώς ήρθατε στο Hoosat Mobile. Για να ξεκινήσετε, μπορείτε να δημιουργήσετε ένα νέο πορτοφόλι ή να εισάγετε ένα υπάρχον πορτοφόλι.';
  ...
  String get compoundRequiredDescription =>
      'Έχετε πολλά μικρά μη δαπανημένα outputs (UTXO). Η ενοποίηση θα τα συγχωνεύσει σε λιγότερα, μεγαλύτερα UTXO ώστε οι μελλοντικές αποστολές να είναι ταχύτερες και ενδεχομένως με χαμηλότερα τέλη. Αυτό δημιουργεί μία ή περισσότερες συναλλαγές και επιφέρει χρεώσεις δικτύου.';
