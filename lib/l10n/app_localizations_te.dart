...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Hoosat నోడ్  జోడించడంలో విఫలమైంది';
  ...
  String get insufficientBalanceDetails =>
      'ఈ లావాదేవీ కోసం మీ వద్ద తగినంత HTN లేదు';
  ...
  @override
  String get hoosatDevFund => 'కస్పా Dev ఫండ్';

  @override
  String get hoosatMobile => 'కాస్పియం వాలెట్';
  ...
  @override
  String get nodeAddress => 'Hoosat నోడ్';

  @override
  String get nodeDeleteMessage => 'మీరు తొలగించాలనుకుంటున్నారా ఖచ్చితంగా?';

  @override
  String get nodeDeleteTitle => 'Hoosat నోడ్ కాన్ఫిగర్‌ని తొలగించాలా?';
  ...
  @override
  String get nodesSheetTitle => 'Hoosat నోడ్స్';
  ...
  @override
  String get shareHoosatMobile => 'కాస్పియం యాప్‌ను భాగస్వామ్యం చేయండి';

  @override
  String get shareHoosatMobileSubject => 'కాస్పియం వాలెట్‌ని తనిఖీ చేయండి';

  @override
  String get shareHoosatMobileText =>
      'కాస్పియం - Hoosat మొబైల్ వాలెట్‌ని తనిఖీ చేయండి.\nవెబ్సైట్ - mobile.hoosat.fi';
  ...
  String transferComplete(String amount) {
    return '$amount HTN మీ కాస్పియం వాలెట్కి విజయవంతంగా బదిలీ చేయబడింది.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount HTN బ్యాలెన్స్ ఉన్న వాలెట్ కనుగొనబడింది.';
  }
  ...
  @override
  String get transferNoFunds => 'ఈ Seedలో HTN ఏదీ లేదు';
  ...
  String welcomeMessage(String version) {
    return 'స్వాగతం!\n\nఇది కాస్పియం యొక్క వెర్షన్ $version - Hoosat కోసం మొబైల్ వాలెట్';
  }
  ...
  @override
  String get hoosatUriInvalid => 'చెల్లని Hoosat URI';
