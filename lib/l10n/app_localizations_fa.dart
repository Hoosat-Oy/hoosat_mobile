...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get hoosatUriCopied => 'Hoosat URI کپی شد';

  @override
  String get hoosatUriCopyFailed => 'Hoosat URI کپی نشد';
  ...
  String get insufficientBalanceDetails =>
      'شما HTN کافی برای این تراکنش ندارید';
  ...
  @override
  String get hoosatDevFund => 'صندوق توسعه دهندگان Hoosat';

  @override
  String get hoosatMobile => 'کیف پول Hoosat Mobile';
  ...
  @override
  String get nodeAddress => 'نود Hoosat';

  @override
  String get nodeDeleteMessage => 'آیا مطمئن هستید که می خواهید حذف کنید؟';

  @override
  String get nodeDeleteTitle => 'پیکربندی نود Hoosat حذف شود؟';
  ...
  @override
  String get nodesSheetTitle => 'نودهای Hoosat';
  ...
  @override
  String get shareHoosatMobile => 'اشتراک گذاری Hoosat Mobile';

  @override
  String get shareHoosatMobileSubject => 'بررسی کیف پول Hoosat Mobile';

  @override
  String get shareHoosatMobileText =>
      'بررسی Hoosat Mobile - کیف پول موبایلی Hoosat\nوبسایت - mobile.hoosat.fi';
  ...
  String transferComplete(String amount) {
    return 'تعداد $amount HTN با موفقیت به کیف پول Hoosat Mobile شما منتقل شد.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'کیف پولی با موجودی $amount HTN شناسایی شد.';
  }
  ...
  String transferIntro(String button) {
    return 'این فرآیند وجوه را از کیف پول کاغذی به کیف پول Hoosat Mobile شما منتقل خواهد کرد.\n\nبرای شروع، \"$button\" را لمس کنید.';
  }
  ...
  @override
  String get transferNoFunds => 'این seed شامل هیچ HTN نمی باشد';

  @override
  String get transferQrScanError => 'این QR کد شامل هیچ seed معتبری نیست.';

  @override
  String get transferQrScanHint => 'اسکن Hoosat\nseed یا کلید خصوصی';
  ...
  String welcomeMessage(String version) {
    return 'خوش آمدید!\n\nاین نسخه شماره $version Hoosat Mobile است - کیف پول موبایلی Hoosat';
  }

  @override
  String get welcomeText =>
      'به Hoosat Mobile خوش آمدید. برای شروع، می توانید یک کیف پول جدید بسازید یا کیف پول موجود را وارد کنید.';
  ...
  String get hoosatUriInvalid =>
      ' Hoosat URI یا شناسه منبع یکپارچه Hoosat نامعتبر است';
  ...
  @override
  String get buyHoosatSubtitle => 'Via Topper توسط Uphold';

  @override
  String get buyHoosatTitle => 'خرید Hoosat';

  @override
  String get buyHoosatMessage => 'HTN\$ را سریع و آسان بخرید.';
