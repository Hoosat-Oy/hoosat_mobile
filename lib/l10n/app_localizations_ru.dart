...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Не удалось добавить ноду Hoosat';
  ...
  String get insufficientBalanceDetails =>
      'У вас не хватает HTN для этой транзакции';
  ...
  @override
  String get hoosatDevFund => 'Фонд разработки Каспы';

  @override
  String get hoosatMobile => 'Кошелёк Hoosat Mobile';
  ...
  @override
  String get nodeAddress => 'Нода Hoosat';

  @override
  String get nodeDeleteMessage => 'Вы уверены, что хотите удалить?';

  @override
  String get nodeDeleteTitle => 'Удалить конфигурацию ноды Hoosat?';
  ...
  @override
  String get nodesSheetTitle => 'Ноды Hoosat';
  ...
  @override
  String get shareHoosatMobile => 'Поделиться Hoosat Mobile';

  @override
  String get shareHoosatMobileSubject => 'Попробуйте кошелёк Hoosat Mobile';

  @override
  String get shareHoosatMobileText =>
      'Попробуйте Hoosat Mobile - мобильный кошелёк Hoosat.\nВеб-сайт - mobile.hoosat.fi';
  ...
  String transferComplete(String amount) {
    return '$amount HTN успешно переведено в кошелёк Hoosat Mobile.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Обнаружен кошелёк с балансом $amount HTN.';
  }
  ...
  String transferIntro(String button) {
    return 'Этот процесс переведёт средства с бумажного кошелька на ваш кошелёк Hoosat Mobile.\n\nНажмите кнопку \"$button\" чтобы начать.';
  }
  ...
  @override
  String get transferNoFunds => 'Эта seed-фраза не имеет HTN.';
  ...
  String welcomeMessage(String version) {
    return 'Добро пожаловать!\n\nЭто версия $version Hoosat Mobile - мобильного кошелька Hoosat';
  }

  @override
  String get welcomeText =>
      'Добро пожаловать в Hoosat Mobile. Вы можете создать новый кошелек или импортировать уже существующий.';
  ...
  @override
  String get hoosatUriInvalid => 'Недействительный URI Hoosat';

  @override
  String get compoundUtxos => 'Сложить транзакции';

  @override
  String get compoundRequired => 'Консолидация мелких UTXO';

  @override
  String get compoundRequiredDescription =>
      'У вас много небольших непотраченных выходов (UTXO). Консолидация объединит их в меньшее количество крупных UTXO, чтобы будущие переводы выполнялись быстрее и, возможно, стоили дешевле. Это создаст одну или несколько транзакций и повлечёт сетевые комиссии.';
