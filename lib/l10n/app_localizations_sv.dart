...
class AppLocalizationsSv extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Misslyckades att lägga till en Hoosat nod';
  ...
  String get insufficientBalanceDetails =>
      'Du har inte nog med HTN för att genomföra transaktionen';
  ...
  @override
  String get hoosatDevFund => 'Hoosats utvecklingsfond';

  @override
  String get hoosatMobile => 'Hoosat Mobile plånbok';
  ...
  @override
  String get nodeAddress => 'Hoosat nod';

  @override
  String get nodeDeleteMessage => 'Är du säker på att du vill radera?';

  @override
  String get nodeDeleteTitle => 'Radera Hoosat nod konfiguration?\n';
  ...
  @override
  String get nodesSheetTitle => 'Hoosat noder';
  ...
  String get passwordNoLongerRequiredToOpenParagraph =>
      'Du kommer inte behöva ett lösenord för att öppna Hoosat Mobile längre.';

  @override
  String get passwordWillBeRequiredToOpenParagraph =>
      'Lösenordet behövs för att öppna Hoosat Mobile.';
  ...
  String get requireAPasswordToOpenHeader =>
      'Kräv lösenord för att öppna Hoosat Mobile?';
  ...
  @override
  String get shareHoosatMobile => 'Dela Hoosat Mobile';

  @override
  String get shareHoosatMobileSubject => 'Kolla in Hoosat Mobile plånboken';

  @override
  String get shareHoosatMobileText =>
      'Prova Hoosat Mobile! Hoosats mobila plånbok. Webbsida - mobile.hoosat.fi';
  ...
  String transferComplete(String amount) {
    return '$amount HTN har överförts till din Hoosat Mobile-plånbok.';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'En plånbok med ett saldo på $amount HTN har upptäckts.\n';
  }
  ...
  String transferIntro(String button) {
    return 'Den här processen kommer att överföra tillgångar från en pappersplånbok till din Hoosat Mobile-plånbok.\n\nTryck på \"$button\" knappen för att starta.';
  }
  ...
  @override
  String get transferNoFunds => 'Detta seed innehåller inga HTN.';
  ...
  @override
  String get unlockBiometrics => 'Verifiera för att låsa upp Hoosat Mobile';

  @override
  String get unlockPin => 'Ange PIN för att låsa upp Hoosat Mobile';
  ...
  String welcomeMessage(String version) {
    return 'Välkommen! Det här är version $version för Hoosat Mobile - den mobila appen för Hoosat';
  }

  @override
  String get welcomeText =>
      'Välkommen till Hoosat Mobile. För att fortsätta så behöver du skapa en ny plånbok eller importera en befintlig plånbok.';
  ...
  @override
  String get hoosatUriInvalid => 'Invalid Hoosat URI';
  ...
  String get compoundRequiredDescription =>
      'Du har många små outnyttjade utgångar (UTXO). Konsolidering sammanför dem till färre, större UTXO:er så att framtida skick går snabbare och kan kräva lägre avgifter. Detta skapar en eller flera transaktioner och medför nätverksavgifter.';
