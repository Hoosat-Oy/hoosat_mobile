...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get insufficientBalanceDetails =>
      'آپ کے پاس اس لین دین کے لیے کافی HTN نہیں ہے';
  ...
  @override
  String get hoosatDevFund => 'کاسپا دیو فنڈ';

  @override
  String get hoosatMobile => 'کاسپیم بٹوا ';
  ...
  @override
  String get nodeDeleteTitle => 'Hoosat Node Config کو حذف کریں؟';
  ...
  @override
  String get shareHoosatMobile => 'Hoosat Mobile کا اشتراک کریں۔';

  @override
  String get shareHoosatMobileSubject => 'Hoosat Mobile Wallet چیک کریں۔';

  @override
  String get shareHoosatMobileText =>
      'Hoosat Mobile - Hoosat Mobile Wallet  ویب سائٹ - mobile.hoosat.fi چیک کریں۔';
  ...
  String transferComplete(String amount) {
    return '$amount HTN کامیابی کے ساتھ آپ کے Hoosat Mobile Wallet میں منتقل ہو گیا۔\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount HTN کے بیلنس والے پرس کا پتہ چلا ہے۔';
  }
  ...
  String transferIntro(String button) {
    return 'یہ عمل کاغذی بٹوے سے آپ کے Hoosat Mobile والیٹ میں رقم منتقل کر دے گا۔\n\n شروع کرنے کے لیے \"$button\" بٹن کو تھپتھپائیں  ۔';
  }
  ...
  @override
  String get transferNoFunds => 'اس سیڈ پر کوئی HTN نہیں ہے۔';

  @override
  String get transferQrScanError => 'اس QR کوڈ میں درست سیڈ نہیں ہے۔';

  @override
  String get transferQrScanHint => 'Hoosat سیڈ یا نجی کلید اسکین کریں۔';
  ...
  String welcomeMessage(String version) {
    return 'خوش آمدید!یہ \n\n  Hoosat Mobile کا ورژن $version ہے - Hoosat کے لیے موبائل والیٹ';
  }

  @override
  String get welcomeText =>
      'Hoosat Mobile میں خوش آمدید۔ شروع کرنے کے لیے، آپ ایک نیا پرس بنا سکتے ہیں یا پہلے سے موجود کو درآمد کر سکتے ہیں۔';
  ...
  String get compoundRequiredDescription =>
      'آپ کے پاس بہت سے چھوٹے غیر خرچ شدہ آؤٹ پٹس (UTXO) ہیں۔ یکجائی انہیں کم، بڑے UTXO میں ضم کر دے گی تاکہ آئندہ بھیجنا تیز ہو اور ممکنہ طور پر کم فیس درکار ہو۔ اس سے ایک یا زیادہ ٹرانزیکشنز بنتی ہیں اور نیٹ ورک فیس لاگو ہوتی ہے۔';
