...
abstract class AppLocalizations {
  ...
  /// No description provided for @hoosatUriCopied.
  ///
  /// In en, this message translates to:
  /// **'Hoosat URI Copied'**
  String get hoosatUriCopied;

  /// No description provided for @hoosatUriCopyFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to copy Hoosat URI'**
  String get hoosatUriCopyFailed;
  ...
  ///
  /// In en, this message translates to:
  /// **'You don\'t have enough HTN for this transaction'**
  ...
  /// No description provided for @hoosatDevFund.
  ///
  /// In en, this message translates to:
  /// **'Hoosat Dev Fund'**
  String get hoosatDevFund;

  /// No description provided for @hoosatMobile.
  ///
  /// In en, this message translates to:
  /// **'Hoosat Mobile Wallet'**
  String get hoosatMobile;
  ...
  /// No description provided for @shareHoosatMobile.
  ///
  /// In en, this message translates to:
  /// **'Share Hoosat Mobile'**
  String get shareHoosatMobile;

  /// No description provided for @shareHoosatMobileSubject.
  ///
  /// In en, this message translates to:
  /// **'Check out Hoosat Mobile Wallet'**
  String get shareHoosatMobileSubject;

  /// No description provided for @shareHoosatMobileText.
  ///
  /// In en, this message translates to:
  /// **'Check out Hoosat Mobile - Hoosat Mobile Wallet.\nWebsite - mobile.hoosat.fi'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{amount} HTN successfully transferred to your Hoosat Mobile Wallet.\n'**
  String transferComplete(String amount);

  /// No description provided for @transferConfirmInfo.
  ///
  /// In en, this message translates to:
  /// **'A wallet with a balance of {amount} HTN has been detected.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This process will transfer the funds from a paper wallet to your Hoosat Mobile wallet.\n\nTap the \"{button}\" button to start.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This seed does not have any HTN on it'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome!\n\nThis is version {version} of Hoosat Mobile - the mobile wallet for Hoosat'**
  String welcomeMessage(String version);

  /// No description provided for @welcomeText.
  ///
  /// In en, this message translates to:
  /// **'Welcome to Hoosat Mobile. To begin, you may create a new wallet or import an existing one.'**
  ...
  /// No description provided for @hoosatUriInvalid.
  ///
  /// In en, this message translates to:
  /// **'Invalid Hoosat URI'**
  String get hoosatUriInvalid;
  ...
  /// No description provided for @buyHoosatSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Via Topper by Uphold'**
  String get buyHoosatSubtitle;

  /// No description provided for @buyHoosatTitle.
  ///
  /// In en, this message translates to:
  /// **'Buy Hoosat'**
  String get buyHoosatTitle;

  /// No description provided for @buyHoosatMessage.
  ///
  /// In en, this message translates to:
  /// **'Buy \$HTN quickly & easily.'**
  String get buyHoosatMessage;

  /// No description provided for @buyHoosatMessageSecondary.
  ///
  /// In en, this message translates to:
